...
export const COMMUNITY_MEMBER_REPOSITORY_PORT = 'COMMUNITY_MEMBER_REPOSITORY_PORT';
...
export interface CommunityMemberRepository {
     ...
     */
    findByUserAndCommunity(userId: string, communityId: string): Promise<CommunityMember | null>;
     ...
     */
    updateStatus(memberId: string, status: MembershipStatus): Promise<CommunityMember>;
