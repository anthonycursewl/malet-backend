...
export class CommunityMembersController {
    ...
    async join(
        ...
        const result = await this.joinCommunityUseCase.execute(user.userId, communityId);
    ...
    async getPendingMembers(
        ...
        const members = await this.manageMembersUseCase.getPendingMembers(user.userId, communityId);
    ...
    async approveMember(
        ...
        const member = await this.manageMembersUseCase.approveMember(user.userId, communityId, memberId);
    ...
    async rejectMember(
        ...
        await this.manageMembersUseCase.rejectMember(user.userId, communityId, memberId);
    ...
    async kickMember(
        ...
        await this.manageMembersUseCase.kickMember(user.userId, communityId, memberId);
    ...
    async banMember(
        ...
        const member = await this.manageMembersUseCase.banMember(user.userId, communityId, memberId);
    ...
    async unbanMember(
        ...
        const member = await this.manageMembersUseCase.unbanMember(user.userId, communityId, memberId);
