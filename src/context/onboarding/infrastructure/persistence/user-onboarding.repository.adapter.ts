...
export class UserOnboardingRepositoryAdapter implements UserOnboardingRepository {
  ...
  async update(
    ...
    if (data.stepInterests !== undefined)
      updateData.step_interests = data.stepInterests;
    if (data.stepCommunities !== undefined)
      updateData.step_communities = data.stepCommunities;
    if (data.stepProfile !== undefined)
      updateData.step_profile = data.stepProfile;
