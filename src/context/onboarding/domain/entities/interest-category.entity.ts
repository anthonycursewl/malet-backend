...
export class InterestCategory {
    ...
    static create(params: Omit<InterestCategoryPrimitives, 'id' | 'createdAt' | 'isActive'>): InterestCategory {
    ...
    static fromPrimitives(primitives: InterestCategoryPrimitives): InterestCategory {
