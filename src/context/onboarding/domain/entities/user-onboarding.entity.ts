...
export class UserOnboarding {
    ...
    hasCompletedInterests(): boolean { return this.stepInterests; }
    hasCompletedCommunities(): boolean { return this.stepCommunities; }
    hasCompletedProfile(): boolean { return this.stepProfile; }
    wasSkipped(): boolean { return this.skipped; }
