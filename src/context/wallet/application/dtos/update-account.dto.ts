import { IsNumber, IsString, IsNotEmpty, MaxLength, MinLength, IsOptional, IsUrl } from "class-validator";
...
export class UpdateAccountDto {
    ...
    @IsNumber({ maxDecimalPlaces: 2 }, { message: 'Balance must be a number with at most 2 decimal places.' })
