import { Controller, Put, Inject, UseInterceptors, UploadedFiles, Body, Req, UseGuards, BadRequestException, Get, Param, UnauthorizedException, Patch } from "@nestjs/common";
import { FileFieldsInterceptor } from "@nestjs/platform-express";
import { UpdateUserProfileDto, UpdateUserProfileUseCase, UPDATE_USER_PROFILE_USECASE } from "src/context/users/domain/ports/in/update-user-profile.usecase";
...
export class UserProfileController {
    ...
    async updateProfile(
        ...
        const { password, ...userWithoutPassword } = updatedUser.toPrimitives();
