...
export class MarkAsReadService implements MarkAsReadUseCase {
    ...
    async execute(userId: string, params: MarkAsReadParams): Promise<MarkAsReadResult> {
        ...
        await this.participantRepository.updateLastReadAt(participant.getId(), lastReadAt);
