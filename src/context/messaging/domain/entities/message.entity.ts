...
export class Message {
    ...
    getEncryptedContent(): string { return this.encryptedContent; }
    getEncryptedKeys(): Record<string, string> { return { ...this.encryptedKeys }; }
    getContentIv(): string { return this.contentIv; }
    getContentTag(): string { return this.contentTag; }
    getType(): MessageType { return this.type; }
    getReplyToId(): string | null { return this.replyToId; }
    getCreatedAt(): Date { return this.createdAt; }
    getUpdatedAt(): Date { return this.updatedAt; }
    getEditedAt(): Date | null { return this.editedAt; }
