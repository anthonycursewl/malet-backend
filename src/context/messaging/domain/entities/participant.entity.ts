...
export class ConversationParticipant {
     ...
     */
    static create(conversationId: string, userId: string, role: ParticipantRole = ParticipantRole.MEMBER): ConversationParticipant {
     ...
     */
    static createAsAdmin(conversationId: string, userId: string): ConversationParticipant {
        return ConversationParticipant.create(conversationId, userId, ParticipantRole.ADMIN);
    }
    ...
    getRole(): ParticipantRole { return this.role; }
    getJoinedAt(): Date { return this.joinedAt; }
    getLastReadAt(): Date | null { return this.lastReadAt; }
    ...
    static fromPrimitives(primitives: ParticipantPrimitives): ConversationParticipant {
