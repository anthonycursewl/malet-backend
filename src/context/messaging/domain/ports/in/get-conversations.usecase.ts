...
export interface GetConversationsUseCase {
     ...
     */
    execute(userId: string, params?: GetConversationsParams): Promise<GetConversationsResult>;

    /**
     * Obtiene una conversación específica por ID
     */
    getById(userId: string, conversationId: string): Promise<ConversationSummary | null>;
}
