...
export class ConversationsController {
    ...
    async getConversation(
        ...
        const result = await this.getConversationsUseCase.getById(user.userId, conversationId);
    ...
    async createPrivate(
        ...
        const result = await this.createConversationUseCase.createPrivate(user.userId, {
    ...
    async createForCommunity(
        ...
        const result = await this.createConversationUseCase.createForCommunity(user.userId, {
