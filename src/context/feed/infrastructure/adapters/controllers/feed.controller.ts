...
// DTOs
import { TrackInteractionDto, TrackViewsDto } from '../dtos/track-interaction.dto';
...
export class FeedController {
    ...
    async trackInteraction(
        ...
        const interaction = await this.trackInteractionUseCase.execute(user.userId, {
    ...
    async trackViews(
        ...
        await this.trackInteractionUseCase.trackViews(user.userId, dto.communityIds);
